...
describe('TodosService', () => {
  ...
  it('findAll', async () => {
    ...
    expect(todos).toMatchObject([
      { id: expect.any(Number), title: 'title1', body: 'body1' },
      { id: expect.any(Number), title: 'title2', body: 'body2' },
    ])
  })

  it('findOne', async () => {
    await repository.save({ title: 'title1', body: 'body1' })
  ...
  it('create', async () => {
    const testCreateTodo = { title: 'title1', body: 'body1' }
  ...
  it('update', async () => {
    const testCreateTodo = { title: 'title1', body: 'body1' }
    const testUpdateTodo = { title: 'updatedTitle1', body: 'updatedBody1' }
